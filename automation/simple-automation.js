...
class SEOContentAutomation {
  ...
  async analyzeTopics() {
    ...
    const opportunities = [
      {
        topic: 'טיימלאפס שיווק ופרסום פרויקטי בנייה 2026 - היתרונות, החסרונות ומה כדאי לקנות',
        englishSlug: 'complete-construction-undefined',
        targetKeywords: [
                    "טיימלאפס שיווק ופרסום פרויקטי בנייה",
                    "טיימלאפס שיווק ופרסום פרויקטי בנייה undefined",
