...
class SEOContentAutomation {
  ...
  async analyzeTopics() {
    ...
    const opportunities = [
      {
        topic: 'מצלמות אבטחה לחקלאות 2027 - היתרונות, החסרונות ומה כדאי לקנות',
        englishSlug: 'cameras-security-agriculture-2027',
        targetKeywords: [
                    "מצלמות אבטחה לחקלאות",
                    "מצלמות אבטחה לחקלאות 2027",
                    "מצלמות אבטחה לחקלאות למכירה",
                    "מצלמות אבטחה לחקלאות מחיר",
                    "מצלמות אבטחה לחקלאות המלצות",
                    "מצלמות אבטחה לחקלאות ביקורות"
          ],
        difficulty: 'medium',
        searchVolume: 16,
        competition: 'medium',
