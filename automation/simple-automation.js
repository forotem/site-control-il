...
class SEOContentAutomation {
  ...
  async analyzeTopics() {
    ...
    const opportunities = [
      {
        topic: 'מצלמות אבטחה לאתרי בנייה 2027 - היתרונות, החסרונות ומה כדאי לקנות',
        englishSlug: 'cameras-security-sites-construction-2027',
        targetKeywords: [
                    "מצלמות אבטחה לאתרי בנייה",
                    "מצלמות אבטחה לאתרי בנייה 2027",
                    "מצלמות אבטחה לאתרי בנייה למכירה",
                    "מצלמות אבטחה לאתרי בנייה מחיר",
                    "מצלמות אבטחה לאתרי בנייה המלצות",
                    "מצלמות אבטחה לאתרי בנייה ביקורות"
          ],
        difficulty: 'medium',
        searchVolume: 4,
        competition: 'medium',
