          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
              <div>
                ...
                <p style={{ color: 'rgba(139, 163, 191, 0.9)', lineHeight: '1.7', fontSize: '0.95rem' }}>מתקינים ומוכרים מצלמות אבטחה, מקליטים, אינטרקום ובקרת כניסה. מלאי בישראל, אחריות שנה, ומצלמות סולאריות 4G לאתרים בלי חשמל.</p>
              ...
              <div>
                ...
                <div style={{ marginTop: '1rem', padding: '16px', background: 'rgba(12, 18, 32, 0.7)', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                  ...
                  <p style={{ fontSize: '0.8rem', color: 'rgba(139, 163, 191, 0.7)', margin: 0 }}>שירות ותמיכה בעברית, מולנו ולא מול היבואן</p>
                </div>
              </div>
            </div>
            <div style={{ 
