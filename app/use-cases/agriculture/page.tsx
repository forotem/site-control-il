...
export const metadata: Metadata = {
  title: "מצלמות אבטחה לחקלאות: פיקוח סולארי 4G לשטח | Site-Control",
  description: "מצלמות סולאריות 4G לשדות, מטעים, חממות ומחסני ציוד בלי חשמל ואינטרנט: התראות לנייד, ראיית לילה צבעונית וגיבוי ענן. משלוח לכל הארץ, התקנה בכל הארץ, בתיאום ולפי הצעת מחיר.",
  keywords: [
