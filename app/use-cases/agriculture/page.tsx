...
export const metadata: Metadata = {
  ...
  description: "מצלמות סולאריות 4G לשדות, מטעים, חממות ומחסני ציוד בלי חשמל ואינטרנט: התראות לנייד, ראיית לילה צבעונית וגיבוי ענן. משלוח לכל הארץ, התקנה במרכז ובדרום.",
  keywords: [
