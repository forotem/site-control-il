    ...
    <main className={styles.wrap}>
      ...
      <section aria-labelledby="what">
        ...
        <div className={styles.why}>
          ...
          <div><b>אתרים בלי חשמל</b><p>לאתרי בנייה, חקלאות ושטחים מרוחקים אנחנו מתקינים מצלמות סולאריות עם סים 4G והקלטה לענן, לפי הצעת מחיר לאתר. <Link href="/contact">דברו איתנו</Link>.</p></div>
