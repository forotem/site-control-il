...
export const storeGuides: Record<string, CategoryGuide> = {
  ...
  kits: {
    id: "kits",
    lead: "ערכה מוכנה של Reolink היא הדרך הקצרה למערכת שעובדת: מקליט עם דיסק (2TB בערכות 4 מצלמות, 4TB בערכות 8), 4 או 8 מצלמות, כבלים ואפליקציה בעברית. הבחירה היא רק בין רזולוציה, גוף המצלמה וצבע בלילה.",
    choose: [
      ...
      { title: "הרחבה", body: "בערכות 4 מצלמות המקליט תומך ב-8, ובערכות 8 מצלמות ב-16. מתחילים קטן ומוסיפים מצלמות Reolink בודדות בהמשך, ואפשר להחליף לדיסק עד 12TB." },
    ],
    terms: [
