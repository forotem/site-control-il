...
export function buildKnowledge(): string {
  ...
  const solar = [
    "מצלמות סולאריות 4G (Reolink GO Plus ו-PTZ Solar עם סים 4G והקלטה לענן) לאתרי בנייה, חקלאות ומקומות בלי חשמל ואינטרנט: זה שירות התקנה לפי הצעת מחיר לאתר, לא מוצר מדף בחנות ואין לו מחיר קבוע באתר. כשלקוח שואל על זה: מסבירים בקצרה מה זה, אוספים שם, טלפון ומה יש במקום (חשמל? אינטרנט? כמה נקודות?), וממלאים lead כדי שהצוות יחזור עם הצעה. דפי מידע: /products/go, /products/ptz, /use-cases.",
