    ...
    <main className={styles.wrap} style={{ gap: "2rem" }}>
      ...
      <section>
        ...
        <ul style={ul}>
          ...
          <li><b>מקור הפנייה:</b> כשאתם נכנסים לאתר, הדפדפן שלכם שומר אצלו (ב-localStorage, ל-90 יום) מאיפה הגעתם, למשל &quot;Google Ads&quot;, שם הקמפיין ומילת החיפוש, ואיזה דף ראיתם ראשון. אם הגעתם ממודעה, נשמר גם מזהה הקליק של גוגל (gclid, gbraid או wbraid). כשאתם שולחים פנייה או הזמנה, המידע הזה מצורף אליה. אנחנו משתמשים במזהה הקליק כדי לדווח לגוגל אם הפנייה הפכה ללקוח (המרה אופליין), בלי למסור לגוגל את השם, הטלפון או המייל שלכם.</li>
