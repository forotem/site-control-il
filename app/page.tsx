...
export const metadata: Metadata = {
  ...
  description:
    "חנות מצלמות אבטחה עם שירות התקנה: Hikvision, Uniview, Reolink ו-VisionNet ציוד מיבואן בישראל. מצלמות IP, מקליטים, אינטרקום ובקרת כניסה. אחריות שנה.",
  alternates: { canonical: BASE_URL },
  openGraph: {
    title: "מצלמות אבטחה, מקליטים ואינטרקום | Site-Control",
    description: "חנות מצלמות אבטחה עם שירות התקנה. מלאי בישראל, אחריות שנה, ייעוץ לפני הקנייה.",
    type: "website",
    locale: "he_IL",
...
const faq = [
  { q: "אתם חנות או חברת התקנות?", a: "שניהם. אנחנו מתקינים מצלמות בבתים, בעסקים ובאתרי בנייה, ואת אותו ציוד אנחנו מוכרים גם באתר. אפשר לקנות לבד ולהתקין עם החשמלאי שלכם, או להזמין התקנה בכל הארץ, בתיאום ולפי הצעת מחיר נפרדת." },
  { q: "המוצרים במלאי?", a: "המוצרים מגיעים ציוד מיבואן בישראל. לפני חיוב אנחנו מאשרים זמינות ומועד אספקה בווצאפ או בטלפון, כך שאף אחד לא משלם על מוצר שאין במלאי." },
  ...
  { q: "מה עם אחריות ושירות?", a: `${WARRANTY_TEXT}, על ציוד מיבואן בישראל. אנחנו מכירים את המוצרים מהשטח, אז כל שאלה או תקלה, מדברים איתנו ואנחנו מבררים בשבילכם. אחרי ההתקנה יש תמיכה טלפונית להגדרות האפליקציה.` },
      ...
      <main className={styles.wrap}>
        <section className={styles.hero}>
          <div className={styles.heroText}>
            <span className={styles.kicker}>חנות מצלמות אבטחה עם שירות התקנה</span>
            <h1>מצלמות אבטחה, מקליטים ואינטרקום. במחיר של חנות אונליין, עם מי שיודע מה מתאים לכם.</h1>
            <p>
              Hikvision, Uniview, Reolink, VisionNet ו-Tenda ציוד מיבואן בישראל. אותם מוצרים שאנחנו מתקינים בבתים, בעסקים ובאתרי בנייה,
        ...
        <section aria-labelledby="why">
          ...
          <div className={styles.why}>
            ...
            <div><b>ציוד מיבואן בישראל</b><p>{WARRANTY_TEXT}. אנחנו מכירים את המוצרים מהשטח, ומתרגמים את השפה הטכנית לעברית פשוטה. שאלה? אנחנו מבררים בשבילכם.</p></div>
