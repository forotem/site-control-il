...
export function buildKnowledge(): string {
  ...
  const policies = [
    ...
    "התקנה: הצוות של Site-Control מתקין במרכז ובדרום, לפי הצעת מחיר (בלי מחיר קבוע ובלי התחייבות לזמן). מחוץ לאזורים האלה: שולחים ציוד לכל הארץ, ואפשר לבדוק התקנה בפנייה. לבקשת התקנה שלח לדף /installation#quote או לווצאפ.",
    "תשלום: כרגע ההזמנה נסגרת בווצאפ או בטלפון מול נציג, אחרי אישור זמינות. אין תשלום אונליין באתר בשלב זה.",
    "קישורים: חנות /store, שאלון התאמה /store/finder, דף מוצר /store/<slug>, התקנה והצעת מחיר /installation#quote, יצירת קשר /contact, ווצאפ https://wa.me/972502256866.",
  ].join("\n");
  const playbook = [
