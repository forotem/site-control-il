...
export function CartDrawer() {
  ...
  return (
    <>
      <button type="button" className={c.cartFab} data-empty={units === 0 ? "true" : undefined} onClick={() => { setOpen(true); setStep(rows.length ? "cart" : "cart"); }} aria-label={`עגלה, ${units} פריטים`} id="store-cart-button">
