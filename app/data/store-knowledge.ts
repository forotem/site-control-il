...
export function buildKnowledge(): string {
  ...
  const solar = [
    ...
    "חשוב לשאול לפני מחיר: עם פאנל סולארי או בלי? רוב הדגמים בלי פאנל (Solar Panel 2 נמכר בנפרד, 139 ₪); Go PT Ultra, Go Ranger ו-TrackMix LTE Plus מגיעים עם פאנל. וגם: קבועה, ממונעת או פנורמית, וכמה נקודות.",
