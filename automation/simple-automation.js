...
class SEOContentAutomation {
  ...
  async analyzeTopics() {
    ...
    const opportunities = [
      {
        topic: 'מצלמות אבטחה חיצוניות עמידות במים 2026 - היתרונות, החסרונות ומה כדאי לקנות',
        englishSlug: 'cameras-security-outdoor-weatherproof-water-2026',
        targetKeywords: [
                    "מצלמות אבטחה חיצוניות עמידות במים",
                    "מצלמות אבטחה חיצוניות עמידות במים 2026",
                    "מצלמות אבטחה חיצוניות עמידות במים למכירה",
                    "מצלמות אבטחה חיצוניות עמידות במים מחיר",
                    "מצלמות אבטחה חיצוניות עמידות במים המלצות",
                    "מצלמות אבטחה חיצוניות עמידות במים ביקורות"
          ],
        difficulty: 'medium',
        searchVolume: 2100,
        competition: 'medium',
