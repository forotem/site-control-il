...
class SEOContentAutomation {
  ...
  async analyzeTopics() {
    ...
    const opportunities = [
      {
        topic: 'טיימלאפס שיווק ופרסום פרויקטי בנייה - מדריך מקצועי 2027 עם טיפים וטריקים',
        englishSlug: 'complete-construction-2027',
        targetKeywords: [
                    "טיימלאפס שיווק ופרסום פרויקטי בנייה",
                    "טיימלאפס שיווק ופרסום פרויקטי בנייה 2027",
